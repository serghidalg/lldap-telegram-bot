...
SERVICES_LIST = (
    f"📺 [Jellyfin](https://play.pyam.org): ver series y pelis (se recomienda instalar la aplicación para que todo funcione correctamente)\n"
    f"🎬 [Seerr](https://seerr.pyam.org): solicitar series y pelis\n"
